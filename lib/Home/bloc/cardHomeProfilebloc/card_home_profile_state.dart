...
class LoadingProfileHome extends CardHomeProfileState {
  LoadingProfileHome(
      // {required super.nama,
      // required super.id,
      // required super.kelas,
...
class ErrorProfileHome extends CardHomeProfileState {
  ErrorProfileHome(
      // {required super.nama,
      // required super.id,
      // required super.kelas,
...
class SuccessProfileHome extends CardHomeProfileState {
  SiswaDetailModels siswaDetailModels;
  SuccessProfileHome({required this.siswaDetailModels});
  @override
  List<Object> get props => [];
}
